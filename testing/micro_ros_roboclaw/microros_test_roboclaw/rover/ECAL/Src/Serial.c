...
#endif
#ifdef USE_USART6
SERIAL_HandleTypeDef* USART6_Serial_Handler;
ring_buffer_t USART6_Buffer_TX, USART6_Buffer_RX;
uint8_t USART6_HAL_Reg_Tx, USART6_HAL_Reg_Rx, USART6_Application_Reg_Tx;
#endif
#ifdef USE_USART4
...
#endif
#ifdef USE_USART6
SERIAL_HandleTypeDef __usart6_serial_handler = {

		.buffer_Tx = &USART6_Buffer_TX,
		.buffer_Rx = &USART6_Buffer_RX,
		.hal_reg_Tx = &USART6_HAL_Reg_Tx,
		.hal_reg_Rx = &USART6_HAL_Reg_Rx,
		.application_reg_Rx = &USART6_Application_Reg_Tx,
		.WriteLock = SERIAL_WRITE_UNLOCKED,
		.ReadLock = SERIAL_READ_UNLOCKED
};
#endif
...
#endif
#ifdef USE_USART6
		if(huartx->Instance == USART6){

			USART6_Serial_Handler = &(__usart6_serial_handler);

			USART6_Serial_Handler->huartx = huartx;
			ring_buffer_init(USART6_Serial_Handler->buffer_Rx);
			ring_buffer_init(USART6_Serial_Handler->buffer_Tx);
			serial_handler = USART6_Serial_Handler;
			HAL_UART_Receive_DMA(USART6_Serial_Handler->huartx, USART6_Serial_Handler->hal_reg_Rx, PRIMARY_REG_SIZE);
		}
#endif
#ifdef USE_USART4
